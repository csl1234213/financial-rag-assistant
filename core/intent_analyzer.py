...
_RESEARCH_SIGNALS = [
    "revenue", "profit", "margin", "ebitda", "earnings", "eps",
    "balance sheet", "income statement", "cash flow", "market cap",
    "dividend", "risk", "growth", "trend", "forecast", "outlook",
    "strategy", "analysis", "analyze", "research", "financial",
    "investment", "sector", "industry", "market", "stock", "price",
    "economy", "economic", "interest rate", "inflation", "gdp",
    "营收", "利润", "净利润", "毛利率", "现金流", "股息",
    "市盈率", "分析", "研究", "风险", "增长", "趋势",
    "投资", "市场", "行业", "财务", "经济",
]
